...
public class FrmPrincipal extends JFrame implements ActionListener {
	...
	public static JMenu mnConfiguracn;
	...
	public static JMenuItem mntmConfigurarCuentas;
	 ...
	 */
	public FrmPrincipal() {
		setTitle("Sistema de Registro y Venta Restaurant Altmar.  | Usuario : "+ConexionSign_In.usuarioIngre);
		setResizable(false);
		...
		mnActualizacin.setVisible(ConexionSign_In.actualizacion);
		...
		mnConfiguracn = new JMenu("Configuraci\u00F3n");
		mnConfiguracn.setIcon(new ImageIcon(FrmPrincipal.class.getResource("/imagen/settings.png")));
		mnConfiguracn.setVisible(ConexionSign_In.configuracion);
		...
		mnConsultas.setVisible(ConexionSign_In.consulta);
		...
		mnGenerarComprobante.setIcon(new ImageIcon(FrmPrincipal.class.getResource("/imagen/boleta o factura.png")));
		...
		mnAbout = new JMenu("Ayuda");
		mnAbout.setIcon(new ImageIcon(FrmPrincipal.class.getResource("/imagen/ayuda.png")));
		menuBar.add(mnAbout);
		
		mntmAbout = new JMenuItem("About");
		mntmAbout.addActionListener(this);
		mntmAbout.setIcon(new ImageIcon(FrmPrincipal.class.getResource("/imagen/privacy.png")));
	...
	protected void actionPerformedMntmAbout(ActionEvent e) {
		About xd=new About();
		xd.setVisible(true);
